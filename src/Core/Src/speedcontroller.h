...
// PWM channels for each wheel
#define WHEEL_A_PWM_1_CHANNEL 0
#define WHEEL_A_PWM_2_CHANNEL 1
#define WHEEL_B_PWM_1_CHANNEL 2
#define WHEEL_B_PWM_2_CHANNEL 3
#define WHEEL_C_PWM_1_CHANNEL 4
#define WHEEL_C_PWM_2_CHANNEL 5 

#define MAX_RPM 300
// Estrutura para representar um vetor 3D (localização e direção)
struct Vect3{
    float x;
    float y;
    float phi;
...
struct Vect3 getCurrentVector();
// Opção para Queue externa
xQueueHandle_t xQueueDir;
